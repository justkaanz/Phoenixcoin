...
#if defined(NDEBUG)
# error "PhoenixCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xcbf337f362a4ebe6c1471ff4bfb7b53a47d978a027d07fa0a43e829546a7adb5");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // PhoenixCoin: starting difficulty is 1 / 2^12
...
{
    // PhoenixCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1260000); // PhoenixCoin: 1,26 million blocks in ~8 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // PhoenixCoin - one weeks
static const int64 nTargetSpacing = 5 * 60; // PhoenixCoin
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // PhoenixCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // PhoenixCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf046f2b6045ad95ebfbb4b1473ea871aa64d0b6e7cb1efa96dbb2cfc96a1b44a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = " 3/5/2021 - The birth of the phoenix from the ashes...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0427d8e32cec50378ebef365fd60f52259494fff37e88aa4a3bb34e72ad6fbe330f2ad11534159c984d20bc28f9a78136eec223ed06be12c3bb704ef21328f6db4") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1614947725;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084692590;

        if (fTestNet)
        {
            block.nTime    = 1614947710;
            block.nNonce   = 387400828;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x9f49891b4ad8177c4342161a314eb02aeb04d6868ddb6f67d27f8c1b22041e12"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfl, 0xc4, 0xb9, 0xdc }; // PhoenixCoin: increase each by adding 2 to bitcoin's value.
...
void static PhoenixCoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running PhoenixCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("PhoenixCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&PhoenixCoinMiner, pwallet));
}
